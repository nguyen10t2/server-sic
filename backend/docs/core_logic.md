...
*   **Kiến trúc Động (Tải từ JSON):** Cấu trúc nhà được cấu hình qua tệp `building_graph.json`, cho phép định nghĩa linh hoạt các nút, đường đi (edges) và các lối thoát hiểm (Exits - ví dụ nút số 5, 10, 15, 20) sao cho phù hợp với bất kỳ toà nhà thực tế nào. Không còn bị giới hạn cứng vào mảng lưới 4x5.
